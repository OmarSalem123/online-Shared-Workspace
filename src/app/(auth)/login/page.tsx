    ...
    <Form {...form}>
        <form onChange={() => {
            ...
            <Link href="/" className="w-full flex justify-left items-center">
                ...
                <span className='font-semibold dark:text-white text-4xl ml-2'>Rawaj</span>
            </Link>
            ...
            <span className='self-center'>Don&apos;t have an account? <Link href={"/signup"} className="text-primary">Sign Up</Link></span>
        </form>
    </Form>
  )
}
