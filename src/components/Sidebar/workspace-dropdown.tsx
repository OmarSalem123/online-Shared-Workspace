...
const WorkspaceDropdown: React.FC<WorkspaceDropdownProps> = ({privateWorkspaces, sharedWorkspaces, collaboratingWorkspaces, defaultValue}) => {
  ...
  return (
    <div className='relative inline-block text-left'>
        ...
        {isOpen && (
            <div className='origin-top-right absolute w-full rounded-md shadow-md z-50 h-[190px] bg-black/10 backdrop-blur-lg group overflow-hidden border-[1px] border-muted'>
                <div className='rounded-md flex flex-col'>
                    <div className='!p-2'>{!!privateWorkspaces.length && (
                        <>
                    ...
                    <CustomDialogTrigger
                     ...
                     description="Workspace give you the power to collaborate with others. you can change workspace privacy settings after creating the workspace too." 
                    >
