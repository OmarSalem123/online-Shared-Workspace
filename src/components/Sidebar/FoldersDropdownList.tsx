...
const FoldersDropdownList:React.FC<FoldersDropdownListPropos> = ({ workspaceFolders, workspaceId}) => {
    //local state folders
    ...
    const addFolderHandler = async () => {
        ...
        if(error){
            ...
            toast({title: "Success",  description:"A new folder has been created"})
        }
    };
  return (
    <>
