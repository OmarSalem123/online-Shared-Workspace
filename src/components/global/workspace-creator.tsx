    ...
    const createItem = async () => {
        ...
        if(user?.id){
            ...
            if(permissions === "private"){
                ...
                toast({title: "Success", description:"A new workspace has been created"})
                router.refresh();
            }
  ...
  return (
    <div className='flex gap-4 flex-col'>
        ...
        <Button type="button" disabled={
            !title || (permissions === 'shared' && collaborators.length === 0) || isLoading} variant={'secondary'} onClick={createItem}>Create</Button>
    </div>
  )
}
